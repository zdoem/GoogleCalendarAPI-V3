...
public class TestCallCalendar {
	...
	public static void main(String[] args) {
		...
		try{
			...
			/*********************************
			 * ÊÓËÃÑº Test Calendar ¡çÊÒÁÒÃ¶·Óä´é â´Â Test ·ÕÅÐ method ÅÍ§ TestInsert
			 *  áÅéÇ copy àÍÒ CalendarId ÁÒ¨Ñ´¡ÒÃ  Get,Delete ä´éµÒÁÊÐ´Ç¡
			 * ******************************/
			//1.Show Calendar 
			...
			//--------------------------------------For Event Manager---------------------------------------------------------
			/**********************************
			 * -ãËé test ´éÇÂ¡ÒÃàÍÒ Remark ÍÍ¡â´Â Test Insert Event ¡èÍ¹ ËÃ×Í¨Ð Test List Event ¡èÍ¹ä´é
			 * á¹Ð¹ÓãËé Test ·ÕèÅÐ method  áÅéÇ copy eventId ÁÒ¨Ñ´¡ÒÃ  Get,Update,Delete µèÍä» 
			 * ********************************/
			//For Event Manager 
	...
	private static void testInsertCalendar(CalendarService calendarService) throws Exception{
		...
		Calendar cal = calendarService.calendarInsert("·´ÊÍº CALENDAR#333");
		View.display(cal);
	...
	private static void testEventInsert(CalendarService calendarService,String calendarId) throws Exception{
		...
		event.setSummary("·´ÊÍº-Event#1");
	   	event.setDescription("·´ÊÍº¤ÃÑº·´ÊÍº àÁ×èÍÃÑ¹àÊÃç¨ãËé¡ÅÑºä»´Ù Calendar ã¹Ë¹éÒ browser Refesh ´Ù");
